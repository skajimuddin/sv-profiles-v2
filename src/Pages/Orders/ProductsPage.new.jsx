    ...
    <>
      ...
      <div className="bg-[var(--secondary-color)] text-white shadow-md">
        <div className="container max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <button
            onClick={viewCart}
            className="flex items-center space-x-1 px-3 sm:px-4 py-2 rounded-lg bg-[var(--primary-color)] text-[var(--secondary-color)] hover:bg-[#c99c4c] transition-colors"
          >
            <svg
          ...
          <div className="mb-4">
            <div className="flex w-full max-w-md mx-auto">
              ...
              <button
                ...
                className={`px-4 py-2 bg-[var(--secondary-color)] text-white rounded-r-md hover:bg-[#162d4d] transition-colors ${
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {filteredProducts.length === 0 ? (
            ...
            filteredProducts.map((product) => (
              <div
                key={product.id}
                className="bg-white rounded-lg shadow-lg overflow-hidden transition-transform hover:scale-[1.02] hover:shadow-xl border border-gray-100"
              >
                <img
