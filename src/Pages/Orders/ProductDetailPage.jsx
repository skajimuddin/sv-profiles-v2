  ...
  if (!product && !loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
        <p className="mt-4 text-lg font-medium text-red-500">Product not found</p>
        <button 
          onClick={backToProducts}
    ...
    <div className="bg-gray-50 min-h-screen pb-12">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="mb-6">
          <ol className="flex text-sm">
            <li className="flex items-center">
              <button onClick={backToProducts} className="text-[var(--secondary-color)] hover:underline">Products</button>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mx-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </li>
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="md:flex">
            ...
            <div className="md:w-1/2 p-6 md:p-8">
              <h1 className="text-3xl font-bold text-[var(--secondary-color)] mb-2">{product.name}</h1>
              <p className="text-2xl font-bold text-[var(--primary-color)] mb-4">${product.price.toFixed(2)}</p>
          ...
          <div className="p-6 border-t">
            <div className="md:flex md:space-x-8">
              ...
              <div className="md:w-1/2 mb-6 md:mb-0">
                <h2 className="text-xl font-semibold text-[var(--secondary-color)] mb-4">Features</h2>
              ...
              {/* Specifications */}
              <div className="md:w-1/2">
                <h2 className="text-xl font-semibold text-[var(--secondary-color)] mb-4">Specifications</h2>
