...
const OrderSummaryPage = () => {
  ...
  const validateForm = () => {
    ...
    try {
      ...
      setErrors({ 
        submitError: error.message || 'There was an error processing your order. Please try again.' 
      });
    ...
    if (loading) {
    return <LoadingSpinner fullScreen={true} message="Loading checkout..." />;
  }
    if (orderComplete) {
    return (
    ...
    <div className="bg-gray-50 min-h-screen py-8">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 mt-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Checkout Form */}
          <div className="lg:col-span-2">            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              {errors.submitError && (
                <ErrorDisplay 
                  ...
                  reset={() => setErrors(prev => ({ ...prev, submitError: null }))}
                />
              )}
