  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
        ...
        <p className="mt-4 text-lg font-medium text-[var(--secondary-color)]">Loading order details...</p>
      </div>
    );
  }
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="bg-[var(--secondary-color)] px-6 py-4">
              <div className="flex flex-col md:flex-row md:justify-between md:items-center">
                <div>
                  <h1 className="text-xl font-bold text-white">Order #{order?.id?.substring(0, 8)}</h1>
                  <p className="text-[var(--primary-color)]">{formatDate(order?.createdAt)}</p>
                </div>
