...
const ForgotPasswordPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Simulate API call - will be replaced with actual Firebase reset in the future
    setTimeout(() => {
      setIsLoading(false);
      setIsSubmitted(true);
      ...
      {!isSubmitted ? (
        <div className="mt-8 space-y-6">
              ...
              >
                {isLoading ? (
                  ...
                  <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                    <svg className="h-5 w-5 text-[#dbac56] group-hover:text-[#c99b49]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div className="text-center">
            <Link to="/signup" className="font-medium text-[#dbac56] hover:text-[#c99b49] text-sm transition duration-150 ease-in-out">
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="pt-4 text-center">
            <Link to="/login" className="inline-flex items-center font-medium text-[#1c3860] hover:text-[#2a5490] text-sm transition duration-150 ease-in-out">
