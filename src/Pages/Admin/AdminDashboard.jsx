  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h2 className="text-2xl font-semibold text-[var(--secondary-color)] mb-6">Dashboard Overview</h2>
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div className="bg-gray-50 px-4 py-3">
              <div className="text-sm">
                <a href="/admin/orders" className="font-medium text-[var(--secondary-color)] hover:text-[#162d4d]">
                  View all orders
                </a>
              </div>
            </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd>
                      <div className="text-lg font-semibold text-gray-900">{stats.pendingOrders}</div>
                    </dd>
                  </dl>
                </div>
              </div>
            ...
            <div className="bg-gray-50 px-4 py-3">
              <div className="text-sm">
                <a href="/admin/orders?status=pending" className="font-medium text-[var(--secondary-color)] hover:text-[#162d4d]">
                  View pending orders
                </a>
              </div>
            </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div className="bg-gray-50 px-4 py-3">
              <div className="text-sm">
                <a href="/admin/products" className="font-medium text-[var(--secondary-color)] hover:text-[#162d4d]">
                  Manage products
                </a>
              </div>
            </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div className="bg-gray-50 px-4 py-3">
              <div className="text-sm">
                <a href="/admin/reports" className="font-medium text-[var(--secondary-color)] hover:text-[#162d4d]">
                  View reports
                </a>
              </div>
            </div>
